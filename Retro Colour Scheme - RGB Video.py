...
while(cap.isOpened()):
    ...
    if ret == True:
        ...
        # Red LOW H
        rLow1 = np.array([0, LOW, LV1])
        rUp1 = np.array([30, HIGH, HIGH])
        rLow2 = np.array([0, LOW, LV2])
        rUp2 = np.array([30, HIGH, LV1])
        rLow3 = np.array([0, LOW, LV3])
        rUp3 = np.array([30, HIGH, LV2])
        rLow4 = np.array([0, LOW, LV4])
        rUp4 = np.array([30, HIGH, LV3])
        rLow5 = np.array([0, LOW, LV5])
        rUp5 = np.array([30, HIGH, LV4])
        rLow6 = np.array([0, LOW, LV6])
        rUp6 = np.array([30, HIGH, LV5])
        rLow7 = np.array([0, LOW, LV7])
        rUp7 = np.array([30, HIGH, LV6])

        # Red HIGH H
        r2Low1 = np.array([151, LOW, LV1])
        r2Up1 = np.array([179, HIGH, HIGH])
        r2Low2 = np.array([151, LOW, LV2])
        r2Up2 = np.array([179, HIGH, LV1])
        r2Low3 = np.array([151, LOW, LV3])
        r2Up3 = np.array([179, HIGH, LV2])
        r2Low4 = np.array([151, LOW, LV4])
        r2Up4 = np.array([179, HIGH, LV3])
        r2Low5 = np.array([151, LOW, LV5])
        r2Up5 = np.array([179, HIGH, LV4])
        r2Low6 = np.array([151, LOW, LV6])
        r2Up6 = np.array([179, HIGH, LV5])
        r2Low7 = np.array([151, LOW, LV7])
        r2Up7 = np.array([179, HIGH, LV6])

        # Green
        gLow1 = np.array([31, LOW, LV1])
        gUp1 = np.array([90, HIGH, HIGH])
        gLow2 = np.array([31, LOW, LV2])
        gUp2 = np.array([90, HIGH, LV1])
        gLow3 = np.array([31, LOW, LV3])
        gUp3 = np.array([90, HIGH, LV2])
        gLow4 = np.array([31, LOW, LV4])
        gUp4 = np.array([90, HIGH, LV3])
        gLow5 = np.array([31, LOW, LV5])
        gUp5 = np.array([90, HIGH, LV4])
        gLow6 = np.array([31, LOW, LV6])
        gUp6 = np.array([90, HIGH, LV5])
        gLow7 = np.array([31, LOW, LV7])
        gUp7 = np.array([90, HIGH, LV6])

        # Blue
        bLow1 = np.array([91, LOW, LV1])
        bUp1 = np.array([150, HIGH, HIGH])
        bLow2 = np.array([91, LOW, LV2])
        bUp2 = np.array([150, HIGH, LV1])
        bLow3 = np.array([91, LOW, LV3])
        bUp3 = np.array([150, HIGH, LV2])
        bLow4 = np.array([91, LOW, LV4])
        bUp4 = np.array([150, HIGH, LV3])
        bLow5 = np.array([91, LOW, LV5])
        bUp5 = np.array([150, HIGH, LV4])
        bLow6 = np.array([91, LOW, LV6])
        bUp6 = np.array([150, HIGH, LV5])
        bLow7 = np.array([91, LOW, LV7])
